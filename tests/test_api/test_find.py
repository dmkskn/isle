...
def test_find_movie():
    results = themoviedb.find(IMDB_MOVIE_ID, src="imdb_id")
...
def test_find_show():
    results = themoviedb.find(IMDB_SHOW_ID, src="imdb_id")
...
def test_find_person():
    results = themoviedb.find(IMDB_PERSON_ID, src="imdb_id")
...
def test_find_episode():
    results = themoviedb.find(TVDB_EPISODE_ID, src="tvdb_id")
...
def test_find_season():
    results = themoviedb.find(TVDB_SEASON_ID, src="tvdb_id")
